  ...
  <section class="section" style="padding-top:140px;" id="blog">
    <div class="container">
      <div class="section__header">
        <span class="badge"><?php echo esc_html( is_home() ? 'المدونة' : get_the_archive_title() ); ?></span>
        ...
        <div class="works-grid">
          ...
          while ( have_posts() ) :
            ...
            <article class="work-card">
              ...
              <h3 class="work-card__title"><a href="<?php the_permalink(); ?>" style="color:inherit;"><?php the_title(); ?></a></h3>
