...
class Theme__WidgetModel__postsmodel extends WP_Widget {
    ...
    public function widget( $args, $instance ) {
        ...
        echo'<div section-concept="true" class="model-postsection"'.( ( !IsSpeed( $intro__image ) ) ? ' data-loader-style="--bg-post:url('.get_template_directory_uri().'/components/styles/img/shape_bkground.jpg'.')"': '' ).'>';
