...
// صفحة هبوط الخدمة: تُرسم فقط للتصنيفات المفعّل فيها الخيار، وبقية التصنيفات تكمل الأرشيف الحالي.
if ( class_exists( 'ServiceLanding' ) && ServiceLanding::enabled( $obj->term_id ) ) {
