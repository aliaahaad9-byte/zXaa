...
class Theme__WidgetModel__intro extends WP_Widget {
    ...
    public function widget( $args, $instance ) {
        ...
        echo '<div  class="page-concept" style="--imgbk:url('.get_template_directory_uri().'/components/styles/img/bg-services.png)">';
            echo '<div class="container">';
                echo'<div class="intro-yu">';
                    foreach($intro as $intropost ){
                        ...
                        echo'<div class="slider-intro">';
                            echo'<div class="info-cover">';
                               ...
                               echo '<p>'.$intropost['description'].'</p>';  
                                echo '<div class="intro_buttun">';
                                    ...
                                    //echo '<a class="content-btn_1" target="_blank" rel="noopener" href="https://api.whatsapp.com/send?phone='.$Whatsapp.'"><span>الواتس اب  </span></a>';
                                echo'</div>';
                                if( !empty(trim($url)) ) {
                            ...
                            if(IsSpeed() == false){
                                echo '<div class="img_back-yu">';
                                    echo '<img widht="100%" height="100%" alt="'.get_option('Sitename').'" data-loader-src="'.$intropost['images']['url'].'"/>';
                                echo'</div>';
                            }
                            }
